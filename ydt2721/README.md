...
│   │   ├── reverse_calc.py # 反向计算模块 🌟
│   │   ├── margin_adjuster.py # 余量调整
...
result = complete_link_budget(
    ...
    # 系统参数
    uplink_availability=99.66,   # 上行可用度 (%)
    downlink_availability=99.66, # 下行可用度 (%)
)
...
print(f"功放功率: {result.clear_sky_hpa_power_W:.2f} W")
```
...
- **核心模块说明**: 见本文档 [核心模块说明](#核心模块说明)
- **标准文档**: YD/T 2721-2014 及 ITU-R P.618 等
